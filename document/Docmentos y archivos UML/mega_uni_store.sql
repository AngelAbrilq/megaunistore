...
DELETE FROM `aportes_seguridad_social`;
...
-- Volcando datos para la tabla mega_uni_store.audit_log: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.cajas: ~0 rows (aproximadamente)
DELETE FROM `cajas`;
...
-- Volcando datos para la tabla mega_uni_store.cajas_movimientos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.categorias: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.impuestos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.inventario: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.metodos_pago: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.movimientos_inventario: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.notificaciones: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.pagos: ~0 rows (aproximadamente)
DELETE FROM `pagos`;
...
-- Volcando datos para la tabla mega_uni_store.permisos: ~0 rows (aproximadamente)
...
INSERT INTO `plataforma` (`id`, `nombre`, `logo_url`, `config_json`, `estado`, `created_at`) VALUES
...
DELETE FROM `prestaciones_sociales`;
...
-- Volcando datos para la tabla mega_uni_store.productos: ~0 rows (aproximadamente)
...
DELETE FROM `productos_atributos`;
...
-- Volcando datos para la tabla mega_uni_store.productos_impuestos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.roles: ~0 rows (aproximadamente)
DELETE FROM `roles`;
...
-- Volcando datos para la tabla mega_uni_store.roles_permisos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.tiendas: ~0 rows (aproximadamente)
DELETE FROM `tiendas`;
...
-- Volcando datos para la tabla mega_uni_store.tiendas_productos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.unidades_medida: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.usuarios: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.usuarios_roles: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla mega_uni_store.ventas: ~0 rows (aproximadamente)
DELETE FROM `ventas`;
...
-- Volcando datos para la tabla mega_uni_store.ventas_detalle: ~0 rows (aproximadamente)
