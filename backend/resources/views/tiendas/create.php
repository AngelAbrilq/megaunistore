...
function e_form_tienda(string $value): string
{
...
<head>
    <meta charset="UTF-8">
    <title>Nueva tienda | Mega_Uni_Store</title>
...
<body>
    <main class="container">
        <h1>Nueva tienda</h1>
        <p>Registra una nueva unidad de negocio dentro del ecosistema multitienda.</p>

        <?php if ($flash !== null): ?>
            <div class="alert">
                <?= e_form_tienda($flash['message']) ?>
            </div>
        <?php endif; ?>

        <section class="card">
            <form action="index.php?route=tiendas.store" method="POST">
                <input type="hidden" name="csrf_token" value="<?= e_form_tienda($csrfToken) ?>">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        <input type="text" id="logo_url" name="logo_url" maxlength="255">
                    </div>
