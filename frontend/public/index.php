...
<head>
  ...
  <!-- Tailwind CDN + configuración de tema -->
  <script src="https://cdn.tailwindcss.com"></script>
  <script>
    tailwind.config = {
      theme: {
        extend: {
          colors: { ink: "#060B1A", navy: "#0B1430", navy2: "#101D43", cyan: "#2EE6FF", violet: "#8B5CFF", gold: "#FFD36A" },
          boxShadow: {
          ...
          keyframes: {
            ...
            pulseSoft: { "0%,100%": { opacity: 0.45 }, "50%": { opacity: 0.9 } },
  ...
  <!-- Tema premium (fondo oscuro y utilidades) -->
  <style>
    :root { --bg-1:#050816; --bg-2:#08112a; --glass:rgba(255,255,255,.06); --stroke:rgba(255,255,255,.1); }
    ...
    body {
      ...
      color: #dbe5ff;
      background:
        radial-gradient(circle at 10% 10%, rgba(46,230,255,.12), transparent 20%),
        radial-gradient(circle at 90% 20%, rgba(139,92,255,.12), transparent 22%),
        radial-gradient(circle at 50% 100%, rgba(255,211,106,.08), transparent 18%),
        linear-gradient(180deg, #040712 0%, #08112a 36%, #050816 100%);
      min-height: 100vh;
      overflow-x: hidden;
    }
    .font-display { font-family: "Poppins", sans-serif; }
    .glass { background: linear-gradient(180deg, rgba(255,255,255,.08), rgba(255,255,255,.03)); backdrop-filter: blur(14px); border: 1px solid rgba(255,255,255,.08); }
    .panel { background: linear-gradient(180deg, rgba(255,255,255,.98), rgba(248,250,255,.96)); border: 1px solid rgba(15,23,42,.08); box-shadow: 0 18px 50px rgba(10,16,40,.08); }
    .shadow-premium { box-shadow: 0 18px 60px rgba(9,17,42,.08), 0 8px 28px rgba(9,17,42,.06); }
    ...
    .accent-gradient { background: linear-gradient(90deg,#2ee6ff 0%,#8b5cff 50%,#ffd36a 100%); }
    .soft-gradient { background: radial-gradient(circle at top left, rgba(46,230,255,.2), transparent 28%), radial-gradient(circle at bottom right, rgba(139,92,255,.16), transparent 28%), linear-gradient(180deg, rgba(255,255,255,.03), rgba(255,255,255,0)); }
    .grid-noise { background-image: linear-gradient(rgba(255,255,255,.04) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,.04) 1px, transparent 1px); background-size: 42px 42px; opacity: .18; mask-image: linear-gradient(180deg, rgba(0,0,0,.8), transparent 94%); }
    .hover-rise { transition: transform .28s ease, box-shadow .28s ease, border-color .28s ease, background .28s ease; }
    .hover-rise:hover { transform: translateY(-6px); box-shadow: 0 18px 50px rgba(9,17,42,.12); }
    .glow-ring { position: relative; }
    .glow-ring::before { content: ""; position: absolute; inset: -1px; border-radius: inherit; padding: 1px; background: linear-gradient(135deg, rgba(46,230,255,.6), rgba(139,92,255,.55), rgba(255,211,106,.45)); -webkit-mask: linear-gradient(#000 0 0) content-box, linear-gradient(#000 0 0); -webkit-mask-composite: xor; mask-composite: exclude; pointer-events: none; opacity: .4; }
    .btn-primary { background: linear-gradient(90deg,#2ee6ff 0%,#2a72ff 35%,#8b5cff 100%); box-shadow: 0 10px 28px rgba(42,114,255,.22); }
    .btn-primary:hover { filter: saturate(1.06) brightness(1.03); transform: translateY(-1px); box-shadow: 0 14px 34px rgba(42,114,255,.26); }
    .btn-outline { background: rgba(255,255,255,.06); border: 1px solid rgba(255,255,255,.1); }
    .btn-outline:hover { background: rgba(255,255,255,.1); transform: translateY(-1px); }
    .section-title { letter-spacing: -.04em; }
    .thin-divider { height: 1px; background: linear-gradient(90deg, transparent, rgba(148,163,184,.35), transparent); }
  </style>
</head>
        ...
        <div
          ...
          <div class="relative max-w-3xl mx-auto">
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="../../backend/public/index.php?route=register"
